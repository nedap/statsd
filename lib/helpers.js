...
function is_valid_packet(fields) {
    ...
    if(fields[2] !== undefined) {
        if(!isValidSampleRate(fields[2]) && !isValidTagsField(fields[2])) {
            return false;
        }
    }
...
exports.is_valid_tags_field = isValidTagsField
exports.is_valid_sample_rate = isValidSampleRate
